<?php
  ...
  if(isset($_REQUEST['status'])){
      ...
      if($s2[0]=="Active"){
        ...
        header("location:moreadmin.php?id=$id");
  } 
  
  $id=$_REQUEST['id'];
  $admin="select * from reg as reg,state as s,city as c,area as a where reg.reg_state=s.state_id AND reg.reg_city=c.city_id AND reg.reg_area=a.area_id AND reg_id='$id' AND reg_user_type='Admin'";
        ...
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    ...
                    <span><a href="manage_admin.php">Back </a></span>
            ...
            <div class="box-content no-padding">
                <table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
                    ...
                    <form>
                        ...
                        <tr>
                        <td>Status</td>
                        <td><a href="moreadmin.php?status=<?php echo $_REQUEST['id'];?>"><?php echo $name['reg_status'];?></a></td>
                        </tr>
